...
Ce script doit être exécuté depuis un serveur de Pod v3. La dernière version de ce script `export_data_from_v3_to_v4.py` est accessible ici:
https://github.com/EsupPortail/Esup-Pod/tree/main/pod/video/management/commands
