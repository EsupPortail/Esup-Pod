...
### 
 ...
 - `CAS_LOGOUT_COMPLETELY`
  ...
  >> See [https://github.com/kstateome/django-cas]() <br>
...
### 
 ...
 - `USE_OPENCAST_STUDIO`
  ...
  >> Activate the [https://opencast.org/](Opencast) studio. <br>
...
### 
 ...
 - `USE_FAVORITES`
  ...
  >> Activation of favorite videos. Allows users to add videos to their favorites. <br>
...
### 
 ...
 - `CELERY_BROKER_URL`
  ...
  > default value: `amqp://pod:xxx@localhost/rabbitpod`
