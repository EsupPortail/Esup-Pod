...
AI_ENRICHMENT_CLIENT_ID = getattr(django_settings, "AI_ENRICHMENT_CLIENT_ID", "mocked_id")
AI_ENRICHMENT_CLIENT_SECRET = getattr(django_settings, "AI_ENRICHMENT_CLIENT_SECRET", "mocked_secret")
