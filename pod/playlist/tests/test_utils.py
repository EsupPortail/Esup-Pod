...
class PlaylistTestUtils(TestCase):
    ...
    def test_user_add_video_in_playlist(self) -> None:
        ...
        self.assertTrue(video_in_playlist, "Test if tuple has been correctly inserted.")
        user_add_video_in_playlist(self.playlist, self.video)
        self.assertEqual(1, get_number_video_in_playlist(self.playlist))
    ...
    def test_user_remove_video_from_playlist(self) -> None:
        ...
        self.assertFalse(video_in_playlist, "Test if tuple has been correctly removed.")
    ...
    def test_check_video_in_playlist(self) -> None:
        ...
        self.assertFalse(check_video_in_playlist(self.playlist, self.video))
        user_add_video_in_playlist(self.playlist, self.video)
        self.assertTrue(check_video_in_playlist(self.playlist, self.video))
        print(" --->  test_check_video_in_playlist ok")

    def test_get_next_rank(self) -> None:
        """Test if test_get_next_rank works correctly."""
        self.assertEqual(1, get_next_rank(self.playlist))
        user_add_video_in_playlist(self.playlist, self.video)
        user_add_video_in_playlist(self.playlist, self.video2)
        self.assertEqual(3, get_next_rank(self.playlist))
        print(" --->  test_get_next_rank ok")

    def test_get_number_playlist(self) -> None:
        """Test if test_get_number_playlist works correctly."""
        self.assertEqual(2, get_number_playlist(self.user))  # Favorites + Playlist1
        self.assertEqual(1, get_number_playlist(self.user2))  # Favorites
    ...
    def test_get_number_video_in_playlist(self) -> None:
        ...
        self.assertEqual(0, get_number_video_in_playlist(self.playlist))
        user_add_video_in_playlist(self.playlist, self.video)
        self.assertEqual(1, get_number_video_in_playlist(self.playlist))
    ...
    def test_get_number_video_added_in_playlist(self) -> None:
        """Test if test_get_number_video_in_playlist works correctly."""
        self.assertEqual(0, get_number_video_added_in_playlist(self.video))
        ...
        self.assertEqual(3, get_number_video_added_in_playlist(self.video))
    ...
    def test_get_playlist_list_for_user(self) -> None:
        ...
        self.assertEqual(3, get_number_playlist(self.user))
        self.assertTrue(
    ...
    def test_get_video_list_for_playlist(self) -> None:
        ...
        self.assertEqual(2, len(get_video_list_for_playlist(self.playlist)))
        self.assertTrue(
    ...
    def test_get_playlist(self) -> None:
        ...
        self.assertEqual(get_playlist(new_playlist.slug), new_playlist)
    ...
    def test_check_password(self):
        ...
        self.assertFalse(check_password("wrong_password", protected_playlist))
