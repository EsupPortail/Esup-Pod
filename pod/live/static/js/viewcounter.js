        ...
        videoJsViewerCount = function(options) {
            ...
            player.ready(function(){
                if( settings.ui ) {
                    ...
                    player.controlBar.info = player.controlBar.el_.appendChild(menuButton.el_);
