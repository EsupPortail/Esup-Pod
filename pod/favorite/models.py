...
class Favorite(models.Model):
    ...
    date_added = models.DateTimeField(verbose_name=_("Date added"), default=timezone.now, editable=False)
    rank = models.IntegerField(verbose_name=_("Rang"), editable=False)
    
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["video", "owner"], name="unique_favorite_video_owner")
        ]
