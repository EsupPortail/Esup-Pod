        ...
        !(function () {
          ...
          (this.Class = function () {}),
            (Class.extend = function (t, r) {
              ...
              return (
                (i.prototype.constructor = a), (i.extend = arguments.callee), i
              );
            }),
            (t.exports = Class);
        })();
        ...
        (function () {
          function n(n) {
            ...
            return function (e, r, i, u) {
              ...
              var o = !A(e) && m.keys(e),
                ...
                a = n > 0 ? 0 : c - 1;
              return (
                arguments.length < 3 && ((i = e[o ? o[a] : a]), (a += n)),
                t(e, r, i, o, a, c)
              );
            };
          }
          ...
          function i(n, t, e) {
            return function (r, i, u) {
              ...
              if ("number" == typeof u)
                n > 0
                  ? (o = u >= 0 ? u : Math.max(u + c, o))
                  : (c = u >= 0 ? Math.min(u + 1, c) : u + c + 1);
              else if (e && u && c) return (u = e(r, i)), r[u] === i ? u : -1;
              if (i !== i)
          ...
          void 0 !== e
            ? (void 0 !== t && t.exports && (e = t.exports = m), (e._ = m))
            : (o._ = m),
            (m.VERSION = "1.8.3");
          ...
          var k = function (n, t) {
              return function (e) {
                ...
                for (var i = 1; i < r; i++)
                  for (
                    var u = arguments[i], o = n(u), c = o.length, a = 0;
                    a < c;
                    a++
                  ) {
                    var s = o[a];
          ...
          (m.each = m.forEach =
            function (n, t, e) {
              t = b(t, e);
              var r, i;
              if (A(n)) for (r = 0, i = n.length; r < i; r++) t(n[r], r, n);
              else {
                var u = m.keys(n);
                for (r = 0, i = u.length; r < i; r++) t(n[u[r]], u[r], n);
              }
              return n;
            }),
            (m.map = m.collect =
            ...
            (m.find = m.detect =
              function (n, t, e) {
                ...
                if (
                  void 0 !==
                    (r = A(n) ? m.findIndex(n, t, e) : m.findKey(n, t, e)) &&
                  -1 !== r
                )
                  return n[r];
              }),
            ...
            (m.every = m.all =
              function (n, t, e) {
                t = x(t, e);
                for (
                  var r = !A(n) && m.keys(n), i = (r || n).length, u = 0;
                  u < i;
                  u++
                ) {
                  var o = r ? r[u] : u;
            ...
            (m.max = function (n, t, e) {
              ...
              if (null == t && null != n)
                for (
                  var c = 0, a = (n = A(n) ? n : m.values(n)).length;
                  c < a;
                  c++
                )
                  (r = n[c]) > u && (u = r);
            ...
            (m.shuffle = function (n) {
              for (
                ...
                (t = m.random(0, u)) !== u && (i[u] = i[t]), (i[t] = e[u]);
              return i;
            }),
            (m.sample = function (n, t, e) {
              return null == t || e
                ? (A(n) || (n = m.values(n)), n[m.random(n.length - 1)])
          ...
          (m.flatten = function (n, t) {
              ...
              function (n, t, e, r) {
                ...
                for (var i = [], u = [], o = 0, c = T(n); o < c; o++) {
                  ...
                  t
                    ? ((o && u === s) || i.push(a), (u = s))
                    : e
                    ? m.contains(u, s) || (u.push(s), i.push(a))
                    : m.contains(i, a) || i.push(a);
                }
                return i;
              }),
            (m.union = function () {
            ...
            (m.intersection = function (n) {
              for (
                var t = [], e = arguments.length, r = 0, i = T(n);
                r < i;
                r++
              ) {
                var u = n[r];
            ...
            (m.unzip = function (n) {
              for (
                var t = (n && m.max(n, T).length) || 0, e = Array(t), r = 0;
                r < t;
                r++
              )
                e[r] = m.pluck(n, r);
          ...
          (m.bind = function (n, t) {
            if (g && n.bind === g) return g.apply(n, p.call(arguments, 1));
            if (!m.isFunction(n))
            ...
            (m.bindAll = function (n) {
              ...
              for (t = 1; t < r; t++) n[(e = arguments[t])] = m.bind(n[e], n);
              return n;
            }),
            (m.memoize = function (n, t) {
              var e = function (r) {
                ...
                return m.has(i, u) || (i[u] = n.apply(this, arguments)), i[u];
              };
              return (e.cache = {}), e;
            }),
                ...
                return (
                  ...
                  l <= 0 || l > t
                    ? (o && (clearTimeout(o), (o = null)),
                      ...
                      (u = n.apply(r, i)),
                      o || (r = i = null))
                    : o || !1 === e.trailing || (o = setTimeout(a, l)),
                  u
                );
              };
            }),
              ...
              var r,
                ...
                a = function () {
                  ...
                  s < t && s >= 0
                    ? (r = setTimeout(a, t - s))
                    : ((r = null),
                      e || ((c = n.apply(u, i)), r || (u = i = null)));
                };
              return function () {
                (u = this), (i = arguments), (o = m.now());
                var s = e && !r;
                return (
                  r || (r = setTimeout(a, t)),
                  s && ((c = n.apply(u, i)), (u = i = null)),
                  c
                );
              };
            }),
          ...
          (m.keys = function (n) {
            ...
            (m.values = function (n) {
              for (
                var t = m.keys(n), e = t.length, r = Array(e), i = 0;
                i < e;
                i++
              )
                r[i] = n[t[i]];
            ...
            (m.mapObject = function (n, t, e) {
              t = x(t, e);
              for (
                var r, i = m.keys(n), u = i.length, o = {}, c = 0;
                c < u;
                c++
              )
                o[(r = i[c])] = t(n[r], r, n);
            ...
            (m.functions = m.methods =
              function (n) {
                var t = [];
                for (var e in n) m.isFunction(n[e]) && t.push(e);
                return t.sort();
              }),
          ...
          var Q = function (n, t, e, r) {
            ...
            (e = e || []), (r = r || []);
            for (var a = e.length; a--; ) if (e[a] === n) return r[a] === t;
            if ((e.push(n), r.push(t), u)) {
              if ((a = n.length) !== t.length) return !1;
              for (; a--; ) if (!Q(n[a], t[a], e, r)) return !1;
            } else {
              var s,
                l = m.keys(n);
              if (((a = l.length), m.keys(t).length !== a)) return !1;
              for (; a--; )
                if (((s = l[a]), !m.has(t, s) || !Q(n[s], t[s], e, r)))
                  return !1;
            }
          ...
          (m.isEqual = function (n, t) {
            ...
            (m.isEmpty = function (n) {
              return (
                null == n ||
                (A(n) && (m.isArray(n) || m.isString(n) || m.isArguments(n))
                  ? 0 === n.length
                  : 0 === m.keys(n).length)
              );
            }),
          ...
          (m.escape = L(M)),
            ...
            (m.result = function (n, t, e) {
              ...
              return void 0 === r && (r = e), m.isFunction(r) ? r.call(n) : r;
            });
          var U = 0;
          ...
          (m.template = function (n, t, e) {
            !t && e && (t = e), (t = m.defaults({}, t, m.templateSettings));
            var r = RegExp(
                [
                  (t.escape || D).source,
                  (t.interpolate || D).source,
                  (t.evaluate || D).source,
                ].join("|") + "|$",
                "g"
              ),
          ...
          (m.mixin = function (n) {
            m.each(m.functions(n), function (t) {
              ...
              m.prototype[t] = function () {
                var n = [this._wrapped];
                return f.apply(n, arguments), B(this, e.apply(m, n));
              };
            });
          }),
            m.mixin(m),
        ...
        t.exports = function (n) {
          ...
          return n.extend(t, {
            constructor: function (n, e) {
              ...
              if (!r.isObject(i))
                throw new Error(
                  'was not provided a "source" object, but rather: ' + typeof i
                );
              (e = r.extend({ selectable: !0, label: i.label }, e)),
                t.call(this, n, e),
                (this.source = i);
            },
          ...
          return (
            (t = n.extend(e, {
              constructor: function (n, t) {
                e.call(this, n, t),
                  ...
                  n.one(
                    "ready",
                    function () {
                      (this.selectedSrc = n.src()), this.update();
                    }.bind(this)
                  ),
              ...
              setSelectedSource: function (n) {
                ...
                this.selectedSrc !== t &&
                  ((this.selectedSrc = t), this.update());
              },
            ...
            n.hook("setup", function (n) {
              n.on(i.QUALITY_REQUESTED, function (t, e) {
                ...
                r.each(i, function (n) {
                  ...
                  (r.findWhere(i, { src: e.src }).selected = !0),
                  n._qualitySelectorSafeSeek &&
                    n._qualitySelectorSafeSeek.onQualitySelectionChange(),
                  n.src(i),
                  n.ready(function () {
                    (n._qualitySelectorSafeSeek &&
                      !n._qualitySelectorSafeSeek.hasFinished()) ||
                      (n._qualitySelectorSafeSeek = new c(n, u)),
                      o || n.play();
                  });
              });
            });
            ...
            return {
              setSource: function (t, e) {
                var u,
                  o = n.currentSources();
                n._qualitySelectorSafeSeek &&
                  n._qualitySelectorSafeSeek.onPlayerSourcesChange(),
                  (u =
                    r.find(o, function (n) {
