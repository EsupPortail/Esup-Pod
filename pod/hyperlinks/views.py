...
def manage_hyperlinks(request):
    ...
    return render(request, 'hyperlinks/manage_hyperlinks.html', {'hyperlinks': hyperlinks})
...
def edit_hyperlink(request, hyperlink_id):
    ...
    return render(request, 'hyperlinks/edit_hyperlink.html', {'form': form, 'hyperlink': hyperlink})
