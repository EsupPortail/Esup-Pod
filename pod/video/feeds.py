...
TITLE_ETB = TEMPLATE_VISIBLE_SETTINGS[
    'TITLE_ETB'] if TEMPLATE_VISIBLE_SETTINGS.get('TITLE_ETB') else 'University name'
TITLE_SITE = TEMPLATE_VISIBLE_SETTINGS[
    'TITLE_SITE'] if TEMPLATE_VISIBLE_SETTINGS.get('TITLE_SITE') else 'Pod'
LOGO_SITE = TEMPLATE_VISIBLE_SETTINGS[
    'LOGO_SITE'] if TEMPLATE_VISIBLE_SETTINGS.get('LOGO_SITE') else 'img/logoPod.svg'
