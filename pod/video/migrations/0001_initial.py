...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='video',
            name='thumbnail',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='video.VideoImageModel', verbose_name='Thumbnails'),
        ),
        migrations.AddField(
            model_name='video',
            name='type',
        ...
        migrations.AddField(
            model_name='theme',
            name='parentId',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='video.Theme'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='channel',
            name='owners',
            field=models.ManyToManyField(blank=True, related_name='owners_channels', to='authentication.Owner', verbose_name='Owners'),
        ),
        migrations.AddField(
            model_name='channel',
            name='users',
            field=models.ManyToManyField(blank=True, related_name='users_channels', to='authentication.Owner', verbose_name='Users'),
        ),
    ]
