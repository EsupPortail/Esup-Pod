# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-12 13:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headband', models.ImageField(blank=True, max_length=255, null=True, upload_to=pod.video.models.get_upload_path_files, verbose_name='Headband')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, max_length=255, null=True, upload_to=pod.video.models.get_upload_path_files, verbose_name='Icon')),
            ],
            options={
                'ordering': ['title'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('infoVideo', models.TextField(blank=True, editable=False, null=True)),
                ...
                ('thumbnail', models.ImageField(blank=True, max_length=255, null=True, upload_to=pod.video.models.get_upload_path_files, verbose_name='Thumbnail')),
                ('licence', models.CharField(blank=True, choices=[('BY', 'Attribution'), ('BY ND', 'Attribution + Pas de Modification'), ('BY NC ND', 'Attribution + Pas d’Utilisation Commerciale + Pas de Modification'), ('BY NC', 'Attribution + Pas d’Utilisation Commerciale'), ('BY NC SA', 'Attribution + Pas d’Utilisation Commerciale + Partage dans lesmêmes conditions'), ('BY SA', 'Attribution + Partage dans les mêmes conditions')], max_length=8, null=True, verbose_name='Licence')),
