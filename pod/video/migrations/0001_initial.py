# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-10 23:01
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_evt', models.DateField(
                    ...
                    null=True, verbose_name='Date of event')),
                ('description', ckeditor.fields.RichTextField(
                    blank=True, verbose_name='Description')),
                ...
                ('is_restricted', models.BooleanField(
                    default=False,
                    help_text='If this box is checked, the video will only be '
                ...
                ('channel', models.ManyToManyField(
                    blank=True, to='video.Channel', verbose_name='Channels')),
                ...
                ('restrict_access_to_groups', models.ManyToManyField(
                    blank=True,
                    help_text='Select one or more groups who can access to '
                    + 'this video', to='auth.Group',
                    verbose_name='Goups')),
