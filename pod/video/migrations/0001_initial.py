    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(max_length=255, upload_to=pod.video.models.get_storage_path, verbose_name='Video')),
                ...
                ('overview', models.ImageField(blank=True, editable=False, max_length=255, null=True, upload_to=pod.video.models.get_storage_path, verbose_name='Overview')),
                ...
                ('restrict_access_to_groups', models.ManyToManyField(blank=True, to='auth.Group', verbose_name='Goups')),
            ],
        ),
        migrations.CreateModel(
            name='ViewCount',
