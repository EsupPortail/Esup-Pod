# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-04-17 12:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(
                    help_text='Used to access this instance, the "slug" is \
                ...
                ('style', models.TextField(
                    blank=True, null=True, verbose_name='Extra style')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[
                    ...
                    default='360p', max_length=10, verbose_name='Name')),
                ('encoding_format', models.CharField(choices=[
                    ('video/mp4', 'video/mp4'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoding_format', models.CharField(choices=[
                    ...
                    ('audio/wav', 'audio/wav'),
                    ('application/x-mpegURL', 'application/x-mpegURL')
                ], default='video/mp4', max_length=22,
                    verbose_name='Format')),
                ('source_file', models.FileField(
                    max_length=255,
                    upload_to=pod.video.models.get_storage_path_video,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(
                    ...
                    related_name='themes', to='video.Channel',
                    verbose_name='Channel')),
            ],
            options={
                'verbose_name': 'Theme',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_nl_NL', ckeditor.fields.RichTextField(
                    blank=True, null=True, verbose_name='Description')),
                ('cursus', models.CharField(choices=[
                    ('0', 'None / All'),
                    ('L', 'Bachelor’s Degree'),
                    ('M', 'Master’s Degree'), (
                        'D', 'Doctorate'),
                ...
                ('main_lang', models.CharField(choices=[
                 ('fr', 'French')
                    ...
                    max_length=2, verbose_name='Main language')),
                ...
                ('licence', models.CharField(
                    ...
                    choices=[
                        ...
                        ('BY NC ND', 'Attribution + Pas d’Utilisation \
                        Commerciale + Pas de Modification'),
                        ('BY NC',
                         'Attribution + Pas d’Utilisation Commerciale'),
                        ('BY NC SA', 'Attribution + Pas d’Utilisation \
                        Commerciale + Partage dans les mêmes conditions'),
                        ('BY SA', 'Attribution + Partage dans les mêmes \
                        conditions')
                    ],
                    max_length=8, null=True, verbose_name='Licence')),
                ...
                ('theme', models.ManyToManyField(
                    blank=True, to='video.Theme', verbose_name='Themes')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolution', models.CharField(
                    ...
                    <em>1920x1080</em>.',
                    max_length=250, verbose_name='resolution')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                to='video.VideoImageModel', verbose_name='Thumbnails'),
        ),
        migrations.AddField(
            model_name='video',
            name='type',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to='authentication.Owner', verbose_name='Owners'),
        ),
        migrations.AddField(
            model_name='channel',
            name='users',
            field=models.ManyToManyField(
                blank=True, related_name='users_channels',
