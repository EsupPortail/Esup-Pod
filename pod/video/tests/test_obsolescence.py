...
class ObsolescenceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        Video.objects.create(
            title="Video2_30", owner=user2, video="test.mp4",
            type=Type.objects.get(id=1),
            date_delete=date.today() + timedelta(days=30))
        Video.objects.create(
            title="Video3_7", owner=user3, video="test.mp4",
            type=Type.objects.get(id=1),
        ...
        vid1 = Video.objects.create(
            title="Video_to_archive", owner=user_faculty, video="test.mp4",
            type=Type.objects.get(id=1))
        ...
        vid2 = Video.objects.create(
            title="Video_to_delete", owner=user4, video="test.mp4",
            type=Type.objects.get(id=1))
