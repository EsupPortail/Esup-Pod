	...
	constructor(
		...
		if (user_id) {
			...
			add_comment.innerHTML = `
                <textarea class="new_comment" name="new_comment" id="comment" rows="10" placeholder="${gettext(
...
function add_user_tag(comment_value, parent_comment) {
	let reply_to = get_comment_attribute(parent_comment, (attr = "author_name"));
