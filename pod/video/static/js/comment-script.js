    ...
    constructor(title = null, message = null, delete_text = null, cancel_text = null) {
        ...
        delete_btn.addEventListener("click", (e) => {
            ...
            if (parent_el.classList.contains("comments_children_container") && parent_el.childElementCount === 0) {
                let parent_e = get_node(parent_el, "comment_element", "comment_child");
...
class Comment extends HTMLElement {
    constructor(owner, content, likes, added_since, id, is_parent = null, is_comment_owner = false) {
        ...
        let vote_action = createFooterBtnAction("comment_actions comment_vote_action", "icon comment_vote_icon", gettext("Agree with the comment"), svg_icon, "comment_vote_btn", `${likes} votes`, id);
        if (is_authenticated) {
