...
(function (global, factory) {
  ...
  var vttThumbnailsPlugin = (function () {
    ...
    vttThumbnailsPlugin.prototype.listenForDurationChange =
      function listenForDurationChange() {
    ...
    vttThumbnailsPlugin.prototype.initializeThumbnails =
    ...
    vttThumbnailsPlugin.prototype.setupThumbnailElement =
      function setupThumbnailElement(data) {
        var _this4 = this;
    ...
    vttThumbnailsPlugin.prototype.showThumbnailHolder =
      function showThumbnailHolder() {
        this.thumbnailHolder.style.opacity = "1";
      };

    vttThumbnailsPlugin.prototype.hideThumbnailHolder =
      function hideThumbnailHolder() {
        this.thumbnailHolder.style.opacity = "0";
      };

    vttThumbnailsPlugin.prototype.updateThumbnailStyle =
      function updateThumbnailStyle(x, width) {
        ...
        this.thumbnailHolder.style.marginLeft =
          "-" + parseInt(currentStyle.width) / 2 + "px";
    ...
    vttThumbnailsPlugin.prototype.getFullyQualifiedUrl =
      function getFullyQualifiedUrl(path, base) {
        if (path.indexOf("//") >= 0) {
    ...
    vttThumbnailsPlugin.prototype.doconstructTimestamp =
      function doconstructTimestamp(timestamp) {
    ...
    vttThumbnailsPlugin.prototype.getSecondsFromTimestamp =
