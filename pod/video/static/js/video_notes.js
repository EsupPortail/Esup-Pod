...
document.addEventListener("submit", function(e){
  ...
  if (e.target.getAttribute('id') == "video_notes_form") {
    ...
    pod_note_submit(e);
  } else if (e.target.matches("div.mgtNotes form, div.mgtNote form, div.mgtComment form")) {
    pod_note_submit(e);
  }
});
...
document.addEventListener('click', function (event) {
  ...
  if (event.target.matches('span.timestamp')){
  ...
  } else if (event.target.matches('.js-note-toggle') || event.target.parentNode.matches('.js-note-toggle')) {
    /**
  ...
  } else if (event.target.matches('.js-comment-toggle') || event.target.parentNode.matches('.js-comment-toggle')) {
    /**
     * Handle click on comment header to toggle partial or full display
     */
    if (event.target.matches('.js-comment-toggle')) {
      form_data = event.target.parentNode.querySelector('.view_video_note_coms_form');
    } else {
      form_data = event.target.parentNode.parentNode.querySelector('.view_video_note_coms_form');
    }
    send_form_data_vanilla(
      form_data.getAttribute("action"),
      "display_notes_place",
     ...
     */
    let video_notes_parent = document.getElementById("video_notes_form").parentNode;
    let data_form;

    if (
      video_notes_parent.querySelector(".view_video_notes_form.d-none")
    ) {
      data_form = video_notes_parent.querySelector(".view_video_notes_form.d-none");
    } else {
      data_form = video_notes_parent.querySelector(".view_video_note_coms_form.d-none");
    }
    send_form_data_vanilla(
    ...
    let data_form = document.getElementById("video_notes_form").parentNode
    .querySelector(".view_video_notes_form.d-none");
    send_form_data_vanilla(
      data_form.getAttribute("action"),
      "display_notes_place",
      data_form
    ...
    let data_form = document.getElementById("video_notes_form").parentNode
    .querySelector(".view_video_note_coms_form.d-none");
    send_form_data_vanilla(
      data_form.getAttribute("action"),
      "display_notes_place",
      data_form
