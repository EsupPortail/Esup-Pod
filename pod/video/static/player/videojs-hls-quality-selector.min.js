...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["video.js"], e)
    : (t.videojsHlsQualitySelector = e(t.videojs));
})(this, function (o) {
  "use strict";
        ...
        function t(o) {
          ...
          (this._invoke = function (i, o) {
            return new Promise(function (t, e) {
              var n = { key: i, arg: o, resolve: t, reject: e, next: null };
  ...
  var h = (function (e) {
      ...
      return (
        ...
        (n.prototype.createMenu = function () {
          var t,
            e = new r(this.player_, { menuButton: this });
          if (((this.hideThreshold_ = 0), this.options_.title)) {
            var n = c.createEl("li", {
                className: "vjs-menu-title",
                innerHTML:
                  ((t = this.options_.title),
                  "string" != typeof t
                    ? t
                    : t.charAt(0).toUpperCase() + t.slice(1)),
                tabIndex: -1,
              }),
              i = new a(this.player_, { el: n });
    ...
    i = (function (r) {
      ...
      return (
        ...
        (u.prototype.handleClick = function () {
          for (var t = 0; t < this.qualityButton.items.length; ++t)
            this.qualityButton.items[t].selected(!1);
      ...
      return (
        ...
        (n.prototype.createQualityButton = function () {
          ...
          var e = t.controlBar.children().length - 2,
            n = t.controlBar.addChild(
              this._qualityButton,
              { componentClass: "qualitySelector" },
              this.config.placementIndex || e
            );
          if (
            (n.addClass("vjs-quality-selector"),
            this.config.displayCurrentQuality)
          )
        ...
        (n.prototype.setQuality = function (t) {
          ...
          (this._currentQuality = t),
            this.config.displayCurrentQuality &&
              this.setButtonInnerText("auto" === t ? t : t + "p");
        ...
        (n.prototype.getCurrentQuality = function () {
    ...
    p = function (n) {
      ...
      this.ready(function () {
        var t, e;
        (t = i),
          (e = o.mergeOptions(y, n)),
          t.addClass("vjs-hls-quality-selector"),
          (t.hlsQualitySelector = new f(t, e));
      });
    };
  return n("hlsQualitySelector", p), (p.VERSION = "1.1.4"), p;
});
