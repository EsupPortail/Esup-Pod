...
player.on('play', function() {
    ...
    context= {
        ...
        "extensions": {
            ...
            "https://w3id.org/xapi/video/extensions/length": player.duration().toFixed(3)
        },
...
player.on('pause', function() {
    ...
    result = {
        "extensions": {
            ...
            "https://w3id.org/xapi/video/extensions/played-segments": time_played + "[.]" + time_paused,
            "https://w3id.org/xapi/video/extensions/progress": (progress.length / player.duration()).toFixed(3),
        }
    }
...
player.on("seeked", function (e) {
    ...
    result = {
        "extensions": {
            ...
            "https://w3id.org/xapi/video/extensions/time-from": last_time[last_time.indexOf(time_seek)-1]
        }
    }
    if(registration == "") registration = create_UUID();
    context= {
...
player.on("ended", function (e) {
    ...
    result = {
        "completion": true,
        "extensions": {
            "https://w3id.org/xapi/video/extensions/played-segments": played_segments.join('[,]'),
            "https://w3id.org/xapi/video/extensions/progress": (progress.length / player.duration()).toFixed(3),
            "https://w3id.org/xapi/video/extensions/time": player.currentTime().toFixed(3)
        }
    }
    if(registration == "") registration = create_UUID();
    context= {
        ...
        "extensions": {
            "https://w3id.org/xapi/video/extensions/session-id": session_id,
            "https://w3id.org/xapi/video/extensions/length": player.duration().toFixed(3),
            "https://w3id.org/xapi/video/extensions/completion-threshold": (parseInt(player.duration())/player.duration()).toFixed(3)
...
player.on("loadedmetadata", function (e) {
    ...
    context= {
        ...
        "extensions": {
            ...
            "https://w3id.org/xapi/video/extensions/video-playback-size": player.currentWidth() + "x" + player.currentHeight(),
            "https://w3id.org/xapi/video/extensions/user-agent": window.navigator.userAgent,
            "https://w3id.org/xapi/video/extensions/speed": player.playbackRate(),
            "https://w3id.org/xapi/video/extensions/completion-threshold": (parseInt(player.duration())/player.duration()).toFixed(3),
            "https://w3id.org/xapi/video/extensions/session-id": session_id,
            "https://w3id.org/xapi/video/extensions/length": player.duration().toFixed(3),
            "https://w3id.org/xapi/video/extensions/quality": current_quality.width + "x" + current_quality.height,
            "https://w3id.org/xapi/video/extensions/screen-size": screen.width + "x" + screen.height,
            "https://w3id.org/xapi/video/extensions/frame-rate": current_quality.frameRate,
...
function get_current_quality() {
    ...
    if(qualitys.length > 0 )
        return qualitys[qualitys.selectedIndex]
}
