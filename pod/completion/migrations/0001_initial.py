        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(
                    max_length=200,
                    verbose_name='lastname / firstname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(
                    editable=False,
                    help_text='Used to access this instance, this "slug" ' +
                    'is a short label containing only letters, numbers, ' +
                ...
                ('time_start', models.PositiveIntegerField(
                    default=1,
                    help_text='Start time of the overlay, in seconds.',
                    verbose_name='Start time')),
                ('time_end', models.PositiveIntegerField(
                    default=2,
                    help_text='End time of the overlay, in seconds.',
                ...
                ('position', models.CharField(
                    ...
                    help_text='Position of the overlay.',
                    max_length=100,
                    null=True,
                    verbose_name='Position')),
                ('background', models.BooleanField(
                    default=True,
                    help_text='Show the background of the overlay.',
                    verbose_name='Show background')),
                ('video', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    to='video.Video',
                    verbose_name='Video')),
            ...
            fields=[
                ...
                ('lang', models.CharField(
                    choices=[
                        ...
                        ('----------', (
                            ('ab', 'Abkhazian'), ('aa', 'Afar'),
                            ('af', 'Afrikaans'), ('sq', 'Albanian'),
                            ('am', 'Amharic'), ('ar', 'Arabic'),
                            ('an', 'Aragonese'), ('hy', 'Armenian'),
                            ('as', 'Assamese'), ('ay', 'Aymara'),
                            ('az', 'Azerbaijani'), ('ba', 'Bashkir'),
                            ('eu', 'Basque'), ('bn', 'Bengali (Bangla)'),
                            ...
                            ('fy', 'Frisian'), ('gl', 'Galician'),
                            ('gd', 'Gaelic (Scottish)'),
                            ('gv', 'Gaelic (Manx)'), ('ka', 'Georgian'),
                            ('de', 'German'), ('el', 'Greek'),
                            ...
                            ('ie', 'Interlingue'), ('iu', 'Inuktitut'),
                            ('ik', 'Inupiak'), ('ga', 'Irish'),
                            ('it', 'Italian'), ('ja', 'Japanese'),
                            ('jv', 'Javanese'), ('kn', 'Kannada'),
                            ('ks', 'Kashmiri'), ('kk', 'Kazakh'),
                            ('rw', 'Kinyarwanda (Ruanda)'), ('ky', 'Kirghiz'),
                            ('rn', 'Kirundi (Rundi)'), ('ko', 'Korean'),
                            ('ku', 'Kurdish'), ('lo', 'Laothian'),
                            ...
                            ('ps', 'Pashto (Pushto)'), ('pl', 'Polish'),
                            ('pt', 'Portuguese'), ('pa', 'Punjabi'),
                            ('qu', 'Quechua'), ('rm', 'Rhaeto-Romance'),
                            ('ro', 'Romanian'), ('ru', 'Russian'),
                            ('sm', 'Samoan'), ('sg', 'Sangro'),
                            ('sa', 'Sanskrit'), ('sr', 'Serbian'),
                            ('sh', 'Serbo-Croatian'), ('st', 'Sesotho'),
                            ('tn', 'Setswana'), ('sn', 'Shona'),
                            ('ii', 'Sichuan Yi'), ('sd', 'Sindhi'),
                            ('si', 'Sinhalese'), ('ss', 'Siswati'),
                            ...
                            ('tt', 'Tatar'), ('te', 'Telugu'),
                            ('th', 'Thai'), ('bo', 'Tibetan'),
                            ('ti', 'Tigrinya'), ('to', 'Tonga'),
                            ('ts', 'Tsonga'), ('tr', 'Turkish'),
                            ('tk', 'Turkmen'), ('tw', 'Twi'),
                            ('ug', 'Uighur'), ('uk', 'Ukrainian'),
                            ('ur', 'Urdu'), ('uz', 'Uzbek'),
                            ('vi', 'Vietnamese'), ('vo', 'Volapük'),
                            ('wa', 'Wallon'), ('cy', 'Welsh'),
                            ('wo', 'Wolof'), ('xh', 'Xhosa'),
