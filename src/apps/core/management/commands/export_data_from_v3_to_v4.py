...
class Command(BaseCommand):
    ...
    def get_table_names(self) -> List[str]:
        ...
        return [
            ...
            # --- FIX: Removed from v3 to v4: video_videotodelete and video_videotodelete_video ---
            # "video_videotodelete",
    ...
    def convert_to_json(
        ...
        for row in rows:
            ...
            # --- FIX: Correction of recurring_until date in the meeting table ---
            if table == "meeting":
                ...
                if (
                    ...
                    # La contrainte V4 accepte "recurring_until IS NULL".
