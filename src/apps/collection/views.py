...
class PlaylistViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        ...
        request={
            "application/json": {
                "type": "object",
                "properties": {
                    "video_id": {"type": "integer", "description": "ID of the video to add."}
                },
                "required": ["video_id"]
            }
        },
        responses={
            201: OpenApiResponse(description="Video added successfully.", response={"type": "object", "properties": {"status": {"type": "string", "example": "video added"}}}),
    ...
    @extend_schema(
        ...
        request={
            "application/json": {
                "type": "object",
                "properties": {
                    "video_id": {"type": "integer", "description": "ID of the video to remove."}
                },
                "required": ["video_id"]
            }
        },
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(description="Playlist reordered successfully.", response={"type": "object", "properties": {"status": {"type": "string", "example": "reordered"}}})
        }
    )
    @action(detail=True, methods=["post"])
